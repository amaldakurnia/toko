    ...
    <div class="container">
        ...
        <div class="col-lg-4">
             <div class="page-header">  
                    <form role="form" class="form-horizontal" action="<?php echo base_url('index.php/admin/ubahhal'); ?>" method="post">
                                    <div class="form-group">
                                        <label> Id Halaman </label>
                                        <input type="text" name="id_halaman" value="<?php echo $key['id_halaman']; ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label> Id Menu </label>
                                        <input type="text" name="id_menu" value="<?php echo $key['id_menu']; ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                         <label> Judul Halaman </label>
                                         <input type="text" name="judul_halaman" value="<?php echo $key['judul_halaman']; ?>" class="form-control">
                                     </div>
                                     <div class="form-group">
