...
<body>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <h2> Data Merk Produk </h2>
                            <a href="<?php echo base_url('index.php/admin/merk'); ?>"></a>
                        </div>
                        </div>
                        <div class="panel-body">
                        <a href="<?php echo base_url ('index.php/admin/savemerk');?>" class="btn btn-success ">Tambah</a>
                        </button>
                        <br><br>
                            <div class="table-responsive table-bordered">
                                ...
                                <?php if (!empty ($list)): ?>
                                    <?php foreach ($list as $key=>$a) : ?>
                                        ...
                                        <a href="<?php echo base_url ('index.php/admin/hapmerk/').$a['id_merk'];?>" class="btn btn-danger ">Delete</a>
                                        </td>
                                        </tr>
                                    <?php endforeach ?>
                                <?php else : ?>
