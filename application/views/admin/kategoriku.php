...
<body>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <h2> Data Kategori </h2>
                            <a href="<?php echo base_url('index.php/admin/kategori'); ?>"></a>
                        </div>
                        </div>
                        <div class="panel-body">
                        <a href="<?php echo base_url ('index.php/admin/savekat');?>" class="btn btn-success ">Tambah</a>
                        </button>
                        <br><br>
                            <div class="table-responsive table-bordered">
                                ...
                                <?php if (!empty ($list)): ?>
                                    <?php foreach ($list as $key=>$a) : ?>
                                        ...
                                        <td align="center">
                                        <a href="<?php echo base_url ('index.php/admin/editkat/').$a['id_kategori'];?>" class="btn btn-primary ">Edit</a> | 
                                        <a href="<?php echo base_url ('index.php/admin/hapkat/').$a['id_kategori'];?>" class="btn btn-danger ">Delete</a>
                                        </td>
                                        </tr>
                                    <?php endforeach ?>
                                <?php else : ?>
