...
<div class="row">
	...
	<a class="logo" href="<?php echo base_url ('customer/');?>"><span>Twitter Bootstrap ecommerce template</span> 
		...
		<a href="<?php echo base_url ('customer/rekonfirm');?>">
	</a>
	</h1>
	</div>
	<div class="span4">
		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class="active"><a href="<?php echo base_url ('customer/rekonfirm');?>">Rekonfirmasi</a></li>
			</ul>
...
-->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Rekonfirmasi</li>
    </ul>
<div class="well">
			<h2> Rekonfirmasi </h2>	
			<?php foreach ($ok as $key => $value) : ?>
			<div class="row-fluid">
			<div class="span7 alignR ">
				<div class="form-horizontal qtyFrm">		
					<h3>Status : <?php echo $value['ket']; ?></h3>
					<div class="btn-group">
				   <a href="<?php echo base_url('customer/konfirm/').$value['kode_order']; ?>" class="shopBtn btn-large"><span class="icon-check"></span> Konfirmasi</a>
		 		</div>
				</div>
			</div>
			</div>
